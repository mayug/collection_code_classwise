...
if __name__ == "__main__":
    ...
    done_batches = len([file for file in os.listdir(f'{LAION_LOCATION}/embeds/embeds_{part}') if "scores" in file and f'_{batch_num}.pt' in file])
    print("Done batches", done_batches)
    imagenet_classes = torch.load(f'class_embeddings/label_to_clip_class.pt').to(device)  
